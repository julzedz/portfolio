const cardData = [
  {
    name: 'Awesome Books',
    description: 'This application lets you compile a dynamic collection of books using JavaScript. It is a single page app. You enter your book title & author in the Add Book section, and it appears on the List section.',
    technologies: ['HTML', 'CSS', 'Vanilla JavaScript'],
    image: './pics/awesomebooks1.png',
    imgMobile: './pics/awesomebooks1.png',
    linkLive: 'https://julzedz.github.io/Awesome-Books/',
    linkSource: 'https://github.com/julzedz/Awesome-Books',
  },
  {
